...
var Client = function () {
    ...
    _createClass(Client, [{
        ...
        key: 'composeOutput',
        value: function composeOutput(data) {
            return {
                data: data,
        ...
        value: function makeRequest(params, path) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                (0, _axios2.default)(r).then(function (response) {
                    ...
                    return resolve(_this.composeOutput(response.data));
                }, function (response) {
                    _this._lastResponse = response;
                    return resolve(_this.composeOutput(response.data));
                }).catch(function (response) {
                    return reject(_this.composeOutput(response.data));
                });
            });
        }
    }]);
